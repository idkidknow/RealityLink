...
class Log4jLogger private (val name: String) extends org.slf4j.Logger {
  ...
  override def trace(
      ...
      arg1: Any,
      arg2: Any,
  ): Unit = logger.trace(marker.adapted, format, arg1, arg2)

  override def trace(marker: Marker, format: String, argArray: Any*): Unit =
    logger.trace(marker.adapted, format, argArray)

  override def trace(marker: Marker, msg: String, t: Throwable): Unit =
    logger.trace(marker.adapted, msg, t)
  ...
  override def debug(
      ...
      arg1: Any,
      arg2: Any,
  ): Unit = logger.debug(marker.adapted, format, arg1, arg2)

  override def debug(marker: Marker, format: String, arguments: Any*): Unit =
    logger.debug(marker.adapted, format, arguments)

  override def debug(marker: Marker, msg: String, t: Throwable): Unit =
    logger.debug(marker.adapted, msg, t)
  ...
  override def info(
      ...
      arg1: Any,
      arg2: Any,
  ): Unit = logger.info(marker.adapted, format, arg1, arg2)

  override def info(marker: Marker, format: String, arguments: Any*): Unit =
    logger.info(marker.adapted, format, arguments)

  override def info(marker: Marker, msg: String, t: Throwable): Unit =
    logger.info(marker.adapted, msg, t)
  ...
  override def warn(
      ...
      arg1: Any,
      arg2: Any,
  ): Unit = logger.warn(marker.adapted, format, arg1, arg2)

  override def warn(marker: Marker, format: String, arguments: Any*): Unit =
    logger.warn(marker.adapted, format, arguments)

  override def warn(marker: Marker, msg: String, t: Throwable): Unit =
    logger.warn(marker.adapted, msg, t)
  ...
  override def error(
      ...
      arg1: Any,
      arg2: Any,
  ): Unit = logger.error(marker.adapted, format, arg1, arg2)

  override def error(marker: Marker, format: String, arguments: Any*): Unit =
    logger.error(marker.adapted, format, arguments)

  override def error(marker: Marker, msg: String, t: Throwable): Unit =
    logger.error(marker.adapted, msg, t)
}

object Log4jLogger {
  private val map: ConcurrentHashMap[String, Log4jLogger] =
