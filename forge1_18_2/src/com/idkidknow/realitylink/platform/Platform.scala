...
import com.idkidknow.realitylink.forge1182.mixin.ServerTranslate
...
object Platform extends API {
  ...
  object Component extends ComponentOps {
    ...
    override def literal(text: String): Component =
      net.minecraft.network.chat.TextComponent(text)
  ...
  override def minecraftVersion: String = "1.18.2"
